...
namespace PrePrueba.Controllers
{
    public class PromosController : Controller
    {
        private readonly PrePruebaContext _context;

        public PromosController(PrePruebaContext context)
        {
            _context = context;
        }
        ...
        {
            var prePruebaContext = _context.Promo.Include(p => p.Burger);
            return View(await prePruebaContext.ToListAsync());
        }
        ...
        {
            ViewData["BurgerID"] = new SelectList(_context.Burger, "BurgerID", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PromoID,Descripcion,FechaPromo,BurgerID")] Promo promo)
        {
            ...
            ViewData["BurgerID"] = new SelectList(_context.Burger, "BurgerID", "Nombre", promo.BurgerID);
            return View(promo);
        }
