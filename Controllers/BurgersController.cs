...
namespace PrePrueba.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(PrePruebaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurgerID,Nombre,ConQueso,Precio")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurgerID,Nombre,ConQueso,Precio")] Burger burger)
        {
